...
describe('DirectoryToolbar', () => {
  it('emits basic search, sort, and direction changes', () => {
    ...
    render(<DirectoryToolbar query={DEFAULT_DIRECTORY_QUERY} total={4} onQueryChange={onChange} />);
    fireEvent.change(screen.getByPlaceholderText(/search/i), { target: { value: 'Ada' } });
    fireEvent.change(screen.getByDisplayValue('First name'), { target: { value: 'age' } });
